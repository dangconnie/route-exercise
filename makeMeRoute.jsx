...
// Just put a 1, 2, 3, 4 or "Home" on the screen if the user clicks on that link IN A NEW ROUTE. You can make your own component(s).
// Use the components I have included to make an app about Atlanta. Make it so each has its own route.
...
// Include the weather
// Style it better than it is with the state vars available
	...
	render: function(){
		...
		return(
			<div>
				...
				<p>The high for today is: {this.state.temp_max}</p>
				<p>The low for today is: {this.state.temp_min}</p>
			</div>
		);
	}
});
...
function Images(props){
	// Map through images to take them out for display
	// Otherwise, you just have an array of images that won't do anything
	console.log(props)
	return(
		<div>
		  ...
		  <div className="container-fluid">
		    ...
		    <ul className="nav navbar-nav">
		    	<li><ReactRouter.IndexLink activeClassName="active" to="/">Home</ReactRouter.IndexLink></li>
		      	...
		      	<li><ReactRouter.Link activeClassName="active" to="/mayorsmessage">Mayors Message</ReactRouter.Link></li>
...
ReactDOM.render(
	<ReactRouter.Router>
		<ReactRouter.Route path="/" component={App} >
			...
			<ReactRouter.Route path="mayorsmessage" component={MayorMessage}/>
